...
const { handleCreateQuiz, handleGetQuiz, handleCreateQuestion, handleGetQuestions, handleDeleteQuiz, handleUpdateQuiz } = require("../controller/quizController");
...
route.delete("/delete-quiz/:id", handleDeleteQuiz);
route.put ("/update-quiz/:id" , handleUpdateQuiz);
